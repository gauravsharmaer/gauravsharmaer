...
RAG Pipelines • LangChain • LangGraph • AI Agents • AWS Bedrock • OpenAI SDK • Hugging Face • DeepGram • ElevenLabs • HeyGen
...
React.js • Next.js • Redux Toolkit • Tailwind CSS • Material UI • Shadcn • TanStack Query • Formik
...
Node.js • Express.js • REST APIs • Server-Sent Events (SSE) • WebSockets • JWT • Nodemailer
...
MongoDB • PostgreSQL • Redis • Pinecone (Vector DB) • AWS (Lambda, S3, Cognito, Polly, CloudWatch) • Docker • Vercel
...
#### **[Hirevize](https://app.hirevize.com/auth) - AI-Powered Interview & Candidate Shortlisting Platform**
...
- 🛠️ **Technologies:** React, Node.js, TypeScript, PostgreSQL, XANO, Cloudinary, AUTH0, ChargeBee
...
#### **[InPharmD](https://staging.inpharmd.com/login) Healthcare Platform** | *Frontend Lead*
...
|---------|-------------|------|
| **Hirevize** | AI-powered recruitment platform | [🔗 Visit](https://app.hirevize.com/auth) |
| **Automator** | JIRA automation with AI agents | [🔗 GitHub](https://github.com/gauravsharmaer/Automator) |
| **InPharmD** | Healthcare platform for medical professionals | [🔗 Visit](https://staging.inpharmd.com/login) |
